...
SOURCE = ROOT / "docs" / "SecurePR Agent知识库.md"
OUTPUT = ROOT / "output" / "pdf" / "SecurePR Agent知识库.pdf"
...
def footer(canvas, document) -> None:
    ...
    canvas.drawString(LEFT, 6.6 * mm, "SecurePR Agent PR Reviewer 知识库")
...
def build() -> None:
    ...
    document = SimpleDocTemplate(
        ...
        topMargin=TOP,
        bottomMargin=BOTTOM,
        title="SecurePR Agent PR Reviewer 知识库",
        author="AgentProject",
        subject="SecurePR Agent 项目知识库",
    )

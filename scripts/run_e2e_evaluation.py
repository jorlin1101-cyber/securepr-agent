...
from securepr_agent.evaluation_benchmark import (  # noqa: E402
    baseline_reviewer,
    candidate_reviewer,
    generate_controlled_pr_cases,
)
from securepr_agent.evaluation_harness import (  # noqa: E402
...
def markdown_report(baseline, candidate, comparison):
    ...
    lines = [
        "# SecurePR Agent 端到端 Evaluation Harness 报告",
        "",
        "## 数据集",
        "",

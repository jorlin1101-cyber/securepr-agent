...
from securepr_agent.evaluation_harness import load_jsonl  # noqa: E402
from securepr_agent.evaluation_v2 import (  # noqa: E402
    FairAblationSuite,
    product_reviewer_factories,
)
from securepr_agent.llm import JsonChatClient  # noqa: E402
...
def main():
    ...
    parser.add_argument("--base-url", default=os.getenv("SECUREPR_LLM_BASE_URL", ""))
    parser.add_argument("--api-key", default=os.getenv("SECUREPR_LLM_API_KEY", ""))
    parser.add_argument("--model", default=os.getenv("SECUREPR_LLM_MODEL", ""))
    parser.add_argument("--provider", default=os.getenv("SECUREPR_LLM_PROVIDER", "custom"))
    ...
    report = suite.run(load_jsonl(args.dataset))

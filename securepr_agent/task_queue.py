...
class TaskQueue:
    STREAM = "securepr:review:stream"
    DLQ = "securepr:review:dlq"
    GROUP = "securepr-workers"
    ...
    def __init__(
        ...
        self._executor = ThreadPoolExecutor(max_workers=workers, thread_name_prefix="securepr-worker")
        self._redis = None

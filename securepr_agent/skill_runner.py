...
def main() -> None:
    ...
    from securepr_agent.diff_parser import ParsedDiff
    from securepr_agent.models import ChangedLine

    spec = importlib.util.spec_from_file_location("securepr_isolated_skill", module_path)
